...
export function MultiSwitch({ selected: initialSelected, items, onToggle }: Readonly<MultiSwitchProps>) {
  ...
  return (
    <div id="MultiSwitch" className="p-2">
      <div className="w-fit rounded-lg inline-flex">
          ...
          return (
            <button
              ...
              className={classNames(
                'inline-flex items-center justify-center py-2 px-3 border-solid border-gray-300 border shadow-lg space-x-1',
                {
